 ...
 * DEVICE IDENTITY
 * ===============
 * Ed25519 keypair generation, localStorage persistence, and payload signing
 * for OpenClaw gateway device authentication.
 *
 * Ported from the official OpenClaw Control UI (ui/src/ui/device-identity.ts).
 */
