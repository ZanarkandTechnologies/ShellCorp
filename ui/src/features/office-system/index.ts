...
export { default as WaterDispenser } from './components/water-dispenser';
export { default as MarbleTable } from './components/marble-table';
export { default as DiningTable } from './components/dining-table';
export { default as ModernDesk } from './components/modern-desk';
